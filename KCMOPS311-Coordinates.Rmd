...
plot(d$longitude, d$XCoordinate, main="XCoordinate vs Longitude (raw)")
plot(d$longitude, d$XCoordinate, main="XCoordinate vs Longitude (raw)", xlim=c(-94.8,-94.3))
grid()
plot(d$latitude,  d$YCoordinate, main="YCoordinate vs Latitude (raw)")
plot(d$latitude,  d$YCoordinate, main="YCoordinate vs Latitude (raw)",  xlim=c(38.4, 39.4))
plot(d$latitude,  d$YCoordinate, main="YCoordinate vs Latitude (raw)",  xlim=c(-94.7,-94.3))
grid()
dev.off()        
```
...
plot(d$latitude[!problems],  d$YCoordinate[!problems], main="YCoordinate vs Latitude")
grid()
fit.X.lat <- lm(d$YCoordinate[!problems] ~ d$latitude[!problems])
abline(fit.X.lat, col="red", lwd=3, lty="dotted")
summary(fit.X.lat)

plot(d$longitude[!problems], d$XCoordinate[!problems], main="XCoordinate vs Longitude")
grid()
